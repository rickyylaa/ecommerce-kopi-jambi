                ...
                <div class="col-lg-4 pb-lg-0 pb-14 order-lg-last">
                    <div class="card border-0 rounded-0 shadow">
                        ...
                        <div class="card-body px-10 py-8">
                            ...
                            <div class="d-flex align-items-center" id="ongkir">
                                <span>Ongkir:</span>
                    ...
                    <div class="alert alert-dark mt-10" role="alert">
                        Untuk pengiriman COD, hubungin admin.
                    </div>
                </div>
                <div class="col-lg-8 order-lg-first pe-xl-20 pe-lg-6">
                    <div class="checkout">
                                    ...
                                    <div class="mb-7">
                                        <div class="row">
                                            <div class="col-md-12 mb-md-0 mb-7">
                                                ...
                                                @if (auth()->guard('customer')->check())
                                                    <input type="text" name="customer_address2" id="customer_address2" class="form-control" placeholder="Alamat Lengkap" value="{{ auth()->guard('customer')->user()->address2 }}" required>
                                                @else
                        ...
                        <div class="nav nav-tabs border-0 mt-7">
                            <input type="checkbox" name="condition" id="cod-open-checkbox" class="form-check-input rounded-0 me-4" value="0" data-bs-toggle="tab" data-bs-target="#cod-open">
                            <label class="text-body-emphasis" for="cod-open-checkbox">
                                <span class="text-body-emphasis">COD (Cash on delivery) untuk daerah kota jambi</span>
                            </label>
                        </div>
                        <div>
...
@if (auth()->guard('customer')->user())
    @section('script')
        ...
        document.addEventListener("DOMContentLoaded", function () {
            var codCheckbox = document.getElementById("cod-open-checkbox");
            var ongkirElement = document.getElementById("ongkir");
            codCheckbox.addEventListener("click", function () {
                codCheckbox.value = codCheckbox.value === "1" ? "0" : "1";
                ongkirElement.classList.toggle("d-none", codCheckbox.value === "1");
            });
        });
        </script>
    @endsection
