    ...
    <div class="container-fluid">
        <div class="row">
            <div class="col-12">
                <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                    <h4 class="mb-sm-0">Laporan Pengembalian</h4>
        ...
        <div class="row">
            <div class="col-xl-12">
                <div class="card">
                    <div class="card-body">
                        <h4 class="card-title mb-4">Laporan Pengembalian</h4>
                        <div class="table-responsive">
                            @role('admin')
                                <form action="{{ url('admin/report/return') }}" method="get">
                            ...
                            @endrole
                            @role('owner')
                                <form action="{{ url('owner/report/return') }}" method="get">
                                    <div class="d-flex mb-3 align-items-center">
                                        <div>
                                            <input type="text" id="created_at" name="date" class="form-control" placeholder="Date">
                                        </div>
    ...
    @section('script')
        <script>
            $(document).ready(function() {
                ...
                $('#exportpdf').attr('href', '/admin/report/return/pdf/' + start.format('YYYY-MM-DD') + '+' + end.format('YYYY-MM-DD'))

                $('#created_at').daterangepicker({
                    startDate: start,
                    endDate: end
                }, function(first, last) {
                    $('#exportpdf').attr('href', '/admin/report/return/pdf/' + first.format('YYYY-MM-DD') + '+' + last.format('YYYY-MM-DD'))
                })
            })
        </script>
    @endsection
    ...
    @section('script')
        <script>
            $(document).ready(function() {
                ...
                $('#exportpdf').attr('href', '/owner/report/return/pdf/' + start.format('YYYY-MM-DD') + '+' + end.format('YYYY-MM-DD'))

                $('#created_at').daterangepicker({
                    startDate: start,
                    endDate: end
                }, function(first, last) {
                    $('#exportpdf').attr('href', '/owner/report/return/pdf/' + first.format('YYYY-MM-DD') + '+' + last.format('YYYY-MM-DD'))
                })
            })
        </script>
    @endsection
