                ...
                <div class="card">
                    <div class="card-body">
                        <div class="dropdown float-end">
                            <button type="button" class="btn btn-primary btn-sm" data-bs-toggle="modal" data-bs-target=".sizeModal">Tambah</button>
                        </div>
                                                ...
                                                <td>
                                                    <div>
                                                        <form method="POST" action="{{ route('size.destroy', $row->id) }}">
                                                            @csrf @method('DELETE')
                                                            <a href="{{ route('size.edit', $row->id) }}" class="text-primary"><i class="mdi mdi-pencil font-size-18"></i></a>
                        ...
                        <div class="d-flex justify-content-between align-items-center px-3">
                            <span class="text-bold">Menampilkan {{ $size->firstItem() }} hingga {{ $size->lastItem() }} dari {{ $size->total() }} entri</span>
...
@section('modal')
<div class="modal fade sizeModal" tabindex="-1" role="dialog" aria-labelledby="sizeModalLabel" aria-hidden="true">
